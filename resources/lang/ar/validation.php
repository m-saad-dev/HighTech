...
return [
    ...
    |
    */
    'not_correct' => 'حقل :attribute غير صحيح.',
    'maxMemberAlert' => 'لقد قمت باختيار باقة بعدد اقل للموظفين',
    'maxMemberSoluation' => 'قم بالغاء تفعيل بعض المستخدمين اولا لتتمكن من اختيار الباقة',
    'areYouSure' => 'هل أنت متأكد',
    'accepted'             => 'يجب قبول :attribute',
    'active_url'           => ':attribute لا يُمثّل رابطًا صحيحًا',
//    'after'                => 'يجب على :attribute أن يكون تاريخًا لاحقًا للتاريخ :date.',
    'after'                => 'يجب أن يكون وقتًا لاحقًا للوقت الذى يسبقة',
    ...
    'PhoneNumberValidate' => 'رقم الجوال وكود الدولة يجب أن تكون صحيحة',
    ...
    */
    ...
    'custom' => [
        ...
        'shift_id' => [
            'required' => 'لابد من إنشاء دوام للشركة',
        ],
        'start' => [
            'unique' => "قيمة تاريخ البداية مُستخدمة من قبل.",
        ],
        'end' => [
            'unique' => "قيمة تاريخ النهاية مُستخدمة من قبل.",
        ],
        'policy_agree' => [
            'required' => "حقل أوافق على شروط الاستخدام مطلوب.",
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'translations.en.description' => trans('fields.description') . trans('common.inEn'),
        'translations.en.title' => trans('fields.title') . trans('common.inEn'),
        'translations.en.subTitle' => trans('fields.subTitle') . trans('common.inEn'),
        ...
        'translations.ar.description' => trans('fields.description') . trans('common.inAr'),
        'translations.ar.title' => trans('fields.title') . trans('common.inAr'),
        'translations.ar.subTitle' => trans('fields.subTitle') . trans('common.inAr'),
