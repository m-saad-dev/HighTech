...
<nav class="navbar navbar-expand-lg navbar-light py-3 topdisk navbar-shrink" id="mainNav">
    <div class="container px-4 px-lg-5">
        <div class="mobile">
            <a class="navbar-brand fixed-top logo" href="{{route('website.home').'#first'}}"><img class="img-fluid" src="{{asset('assets/website/img/logo2.png')}}" alt="{{$logoTitle['ar']}}"></a>
        ...
        <div class="collapse navbar-collapse fixed-top" id="navbarResponsive">
            <ul class="navbar-nav ms-auto my-2 my-lg-0">
                ...
                <li class="nav-item"><a class="nav-link cat3 @if(request()->route()->getName() == 'website.clients') active @endif" href="{{route('website.home').'#th'}}">عملائنا</a></li>
                ...
                <li class="nav-item"><a class="nav-link @if(request()->route()->getName() == 'website.articles.show' || request()->route()->getName() == 'website.blog') active @endif" href="{{route('website.home').'#se'}}">مدونة هاى تك</a></li>
