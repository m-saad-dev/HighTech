...
<div class="card-body border-top p-9">
    ...
    <div class="row mb-6">
        ...
        <!--begin::Col-->
        <div class="col-lg-8 fv-row">
            <input type="tel" name="phone" class="form-control form-control-lg form-control-solid {{app()->getLocale() == 'ar' ? 'align-content-end' : 'align-content-start'}}" style='direction:{{app()->getLocale() == 'ar'? 'rtl' : 'ltr'}} !important;' placeholder="Phone number" value="044 3276 454 935" />
        </div>
        <!--end::Col-->
    </div>
    <!--end::Input group-->
