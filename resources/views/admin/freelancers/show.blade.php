...
@section("title", trans("menu.freelancer"))
@section('breadcrumb')
    @include('admin.layouts.breadcrumb_segmants', [
        'menu'      => [
            trans('menu.freelancer') => route('admin.freelancers.index'),
            trans('freelancer.showClient') => null,
        ],
    ])
@stop
@section('page_title')
    @lang('freelancer.showClient')
@stop
@section('actions')
    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                ...
                <!--begin::Col-->
                <div class="col-lg-8">
                    <span class="fw-bold fs-6 text-gray-800">{{$freelancer->name}}</span>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
